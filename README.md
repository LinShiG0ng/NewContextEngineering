...
🔑 关键实体:
  • 文件: main.py, data_processor.py, config.json
  • 函数: load_data, clean_data, analyze_sales
  • 类: DataProcessor
  • 错误: TypeError at line 42

💬 关键讨论点:
1. [important] 👤 我想创建一个Python数据分析项目...
2. [critical] 🤖 好的！我可以帮助你创建。首先定义一个DataProcessor类...
3. [important] 👤 继续添加数据清洗功能...
...

💡 提示: 这些内容会在构建上下文时自动包含
```

#### 使用 `/context` 命令查看当前上下文：
